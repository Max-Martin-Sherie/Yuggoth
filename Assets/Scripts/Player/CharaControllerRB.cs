...
public class CharaControllerRB : MonoBehaviour
{
    ...
    private void LowerGarvityOnSlopes()
    {
        ...
        Debug.DrawRay(transform.position,-Physics.gravity* (Vector3.Angle(m_groundNormal,Vector3.up)/45) ,Color.red);
        Debug.Log(Vector3.Angle(m_groundNormal,Vector3.up)/45);
    }
